...
#define Pompe_G 0x255
#define Pompe_D 0x256
#define VENT_G 0x266
#define VENT_D 0x267
...
// Odométrie
#define OdoG 0x028   // Odométrie position robot gauche
#define OdoD 0x026 // Odométrie position robot droite
#define Odo_request 0x027 // Demande odométrie  (Demande la position actuel du robot)
...
// Lidar
#define IDCAN_POS_XY_OBJET 0x82 //&#160;Position XY de l'objet détecté
